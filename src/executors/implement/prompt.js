...
export function buildImplementPrompt({
  ...
  if (shouldPropose) {
    parts.push(
      ...
      'IMPORTANT: Your FINAL message must be the complete proposal. Do all research and exploration first, then write the full proposal as your last response — it will be posted as a comment on the issue.',
      'You have a limited turn budget. Do not over-explore — gather what you need, then produce the proposal. If you run out of turns before writing the proposal, your last intermediate message is all that gets posted.',
    ...
    parts.push(
      ...
      'NEVER include "Co-Authored-By", "Generated by", or any other AI attribution in commit messages.', '',
    );
  }
